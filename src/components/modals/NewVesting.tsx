...
interface NewVestingScheduleModalProps {
  showModal: boolean;
  closeModal: () => void;
  handleCreateVestingContract: (firstName : string, lastName : string , title : string,request : Vesting.VestingRequest) => void;
            ...
            <div className="modal-footer">
              <div className='container'>
                <div className='row'>
                  ...
                  <div className='col'>
                    <button type="button" disabled={loading} className="btn btn-primary w-100" onClick={handleSubmit}>
                      Create schedule 
                      <HashLoader
                        color="#DA70D6"
                        loading={loading}
